    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='albums', to='genre.genre')),
                ('moods', models.ManyToManyField(blank=True, related_name='albums', to='mood.mood')),
            ],
        ),
    ]
